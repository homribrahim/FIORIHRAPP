			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hrplatform-display": {
								"semanticObject": "hrplatform",
								"action": "display",
								"description": "An SAP Fiori HR App",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hrplatform",
									"url": sap.ui.require.toUrl("hrplatform")
								}
							}
						}
					}
